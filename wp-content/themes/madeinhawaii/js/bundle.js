...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _domready2.default)(function () {
	  ...
	  btn.addEventListener('click', function () {
	    ...
	    var exists = Array.from(document.querySelectorAll('#products option')).filter(function (opt) {
	      return opt.textContent == val;
	    });
	    if (exists.length === 0) {
	      _notie2.default.alert('error', val + ' is not a valid product title');
	      return;
	    }
